...
const NAV_SECTIONS = [
  {
    ...
    items: [
      ...
      { href: "/hypervisor", label: "Hypervisor", icon: ClientsIcon },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/approvals", label: "Approvals", icon: SkillIcon },
      { href: "/skills", label: "Skill Review", icon: SkillIcon },
      { href: "/identities", label: "Identities", icon: KeyIcon },
      { href: "/discovery", label: "Discovery", icon: SkillIcon },
      { href: "/trust", label: "Trust", icon: ShieldIcon },
      { href: "/compliance", label: "Compliance", icon: AuditIcon },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/metrics", label: "Metrics", icon: DashboardIcon },
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 py-5 flex items-center gap-3">
        <div className="w-9 h-9 rounded-lg bg-primary/20 flex items-center justify-center text-xl">🛡</div>
        <span className="text-lg font-bold text-neutral-content tracking-tight">ClawForge</span>
      </div>
      ...
      <div className="px-4 py-4 border-t border-white/10">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-neutral-content truncate">{auth?.email ?? "Admin"}</p>
